...
@section('konten')
  <h4>Welcome  <b>{{Auth::user()->username}}</b>, Your email is <b>{{Auth::user()->email}}</b>.</h4>
@endsection
<!DOCTYPE html>
              ...
              <div class="main-panel">
                <div class="content-wrapper">
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="home-tab">
                        <h3><a href="{{route('main')}}"> Go to Landing page</a></h3>
                                        ...
                                        <div class="row">
                                          <div class="col-lg-12">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                              ...
                                              <div>
                                                <div class="dropdown">
                                                  <button class="btn btn-light dropdown-toggle toggle-dark btn-lg mb-0 me-0" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Month Wise
                                                  </button>
