    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item {{ request()->is('landing') ? 'active' : '' }}"><a href="{{ url('landing') }}" class="nav-link">Home</a></li>
          ...
          <li class="nav-item {{ request()->is('car') ? 'active' : '' }}"><a href="{{ url('car') }}" class="nav-link">Cars</a></li>
