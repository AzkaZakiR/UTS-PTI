		              ...
		              <div class="form-group">
			            ...
			            <div class="form-group">
	  					...
	  					<div class="col-md-8 d-flex align-items-center">
					        ...
					        <p><a href="{{url('carslist')}}" class="btn btn-primary py-3 px-4">Reserve Your Perfect Car</a></p>
	  						</div>
	  					</div>
	  				</div>
				</div>
    						...
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						...
		    						<div class="d-flex mb-3">
			    						...
			    						<p class="price ml-auto">Rp. {{$car->price_per_day}} <span>/day</span></p>
		    						</div>
		    						<p class="d-flex mb-0 d-block"><a href="{{route('checkoutcar', ['id' => $car->id])}}" class="btn btn-primary py-2 mr-1">Book now</a> 
                      <a href="{{route('cardetail', ['id' => $car->id])}}" class="btn btn-secondary py-2 ml-1">Details</a></p>
		    					</div>
		    				</div>
    					</div>
              @endforeach
